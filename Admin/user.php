    ...
    <div class="row">
      ...
      <div class="col-md-10 m-auto">
        ...
        <h4 class="text-center">Users Table <span class="badge badge-primary"> <?php echo $userCount ?></span>
          <a href="user.php?page=create" class="btn btn-success">Crate new user</a>
        </h4>
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td><?php echo $item['usename'] ?></td>
                <td><?php echo $item['email'] ?></td>
                <td>
                  <a href="user.php?page=show&user_id=<?php echo $item['user_id'] ?>" class="btn btn-success">
                    <i class="fa-solid fa-eye"></i>
                  </a>


                  <a href="user.php?page=edit&user_id=<?php echo $item['user_id'] ?>" class="btn btn-primary">
                    <i class="fa-solid fa-pen-to-square"></i>
                  </a>

                  <a href="user.php?page=delete&user_id=<?php echo $item['user_id'] ?>" class="btn btn-danger">
        ...
        <table class="table table-dark text-center">
          ...
          <tbody>
            ...
            <td>
              ...
              <?php
              echo $result['user_id'] ?></td>
            <td><?php
                echo $result['usename'] ?></td>
            <td><?php
            ...
            <td>
              <a href="user.php" class="btn btn-success"><i class="fa-solid fa-house"></i></a>
            </td>
            </tr>
...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($id)) {
      ...
      $_SESSION['role'] = $role;
      header("Location:user.php?page=savenew");
    }
  }
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-10 m-auto">
        ...
        ?>
        <form action="user.php?page=create" method="post">
          <label>ID</label>
...
<?php
  ...
  $role = $_SESSION['role'];
  try {
    $statment = $connect->prepare("INSERT INTO users (user_id,usename,email, `password`, `status`, `role`,created_at) VALUES (?,?,?,?,?,?,now())");
    ...
    header("Location:user.php?page=create");
  }
} elseif ($page == "edit") {
  if (isset($_GET['user_id'])) {
    $user_id = $_GET['user_id'];
  ...
  <div class="container mt-2">
    <div class="row">
      ...
      <?php
       ...
       ?> 
        <form method="post" action="user.php?page=saveupdate">
          ...
          <label>Name</label>
          <input type="text" name="user" class="form-control mb-4" value="<?php echo $result['usename']; ?>">
          <label>Email</label>
  ...
  if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $role = $_POST['role'];
    try {
      $statment = $connect->prepare("UPDATE users
      SET user_id=?,
      usename=?,
      email=?,
     `password`=?,
     ...
     ");
      ...
      $_SESSION['error'] = "Duplicate ID";
      header("Location:user.php?page=edit&user_id=$oldid ");
    }
  }
}
